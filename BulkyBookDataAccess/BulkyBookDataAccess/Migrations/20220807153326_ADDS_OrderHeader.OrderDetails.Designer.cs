...
namespace BulkyBookDataAccess.Migrations
{
    ...
    [Migration("20220807153326_ADDS_OrderHeader.OrderDetails")]
    partial class ADDS_OrderHeaderOrderDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyBook.Models.ViewModels.ShoppingCardVM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBookModels.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBookModels.ApplicationIdentityUser", b =>
                {
            ...
            modelBuilder.Entity("BulkyBook.Models.OrderHeader", b =>
                {
                    b.HasOne("BulkyBookModels.ApplicationIdentityUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BulkyBook.Models.ViewModels.ShoppingCardVM", b =>
                {
                    b.HasOne("BulkyBookModels.ApplicationIdentityUser", "applicationIdentityUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BulkyBookModels.ApplicationIdentityUser", b =>
                {
                    b.HasOne("BulkyBookModels.Company", "Company")
                        .WithMany()
